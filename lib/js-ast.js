...
// eval
function ast_eval (data) {
	this.type = 'eval'
	this.data = data
}
ast_eval.prototype.run = function (cache, scope) {
	debug('eval:', 'var ' + scope.var + ';' + this.data)
	return scope.var.length
		? eval('var ' + scope.var + ';' + this.data)
		: ''
}
// if
